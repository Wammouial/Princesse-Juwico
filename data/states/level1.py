...
class Level1(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.game_info[c.LEVEL_NUMBER] = '1-1'
    ...
    def setup_steps(self):
        ...
        step1 = collider.Collider(0,422,787,178)
        step2 = collider.Collider(872,422,187,178)
        step3 = collider.Collider(1059,375,280,225)
        step4 = collider.Collider(1340,422,458,178)


        step5 = collider.Collider(1798,412,112,188)
        step6 = collider.Collider(1910,450,38,150)
        step7 = collider.Collider(1948,487,37,113)
        step8 = collider.Collider(1985,525,216,75)

        step9 = collider.Collider(2201,487,38,113)
        step10 = collider.Collider(2239,450,37,150)
        step11 = collider.Collider(2276,412,122,188)
        step12 = collider.Collider(2398,421,102,179)
        step13 = collider.Collider(2500,450,71,150)

        step14 = collider.Collider(2571,478,62,122)
        step15 = collider.Collider(2632,506,82,94)
        step16 = collider.Collider(2714,534,82,66)
        step17 = collider.Collider(2796,562,70,38)

        step18 = collider.Collider(2866,591,11,9)
        step19 = collider.Collider(2877,598,900,25)
        step20 = collider.Collider(3776,592,48,8)
        step21 = collider.Collider(3824,566,66,34)
        step22 = collider.Collider(3890,540,56,60)
        step23 = collider.Collider(3947,515,56,85)
        step24 = collider.Collider(4003,490,66,110)
        step25 = collider.Collider(4070,465,65,135)
        step26 = collider.Collider(4135,439,665,161)

        step27 = collider.Collider(2897,400,870,78)
        step28 = collider.Collider(2960,149,751,197)
    ...
    def setup_flag_pole(self):
        ...
        self.flag = flagpole.Flag(4466, 100)

        pole0 = flagpole.Pole(4466, 97)
        pole1 = flagpole.Pole(4466, 137)
        pole2 = flagpole.Pole(4466, 177)
        pole3 = flagpole.Pole(4466, 217)
        pole4 = flagpole.Pole(4466, 257)
        pole5 = flagpole.Pole(4466, 297)
        pole6 = flagpole.Pole(4466, 337)
        pole7 = flagpole.Pole(4466, 377)
        pole8 = flagpole.Pole(4466, 417)

        finial = flagpole.Finial(4466, 97)
    ...
    def setup_juwico(self):
        ...
        self.juwico.rect.bottom = c.GROUND_HEIGHT_LEVEL1
    ...
    def blit_everything(self, surface):
        ...
        #self.check_point_group.draw(self.level)  #If needed to see them
