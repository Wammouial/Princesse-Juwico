...
class Level2(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.game_info[c.COIN_TOTAL] = 3  #3 badguys
        self.game_info[c.LEVEL_NUMBER] = '1-2'
        ...
        self.overhead_info_display = info.OverheadInfo(self.game_info, c.LEVEL2)
    ...
    def setup_steps(self):
        ...
        step1 = collider.Collider(0,421,2442,179)
        step2 = collider.Collider(2866,421,1934,179)
        
        #Champis
        step3 = collider.Collider(920,297,146,76)
        step4 = collider.Collider(979,373,48,77)


        step5 = collider.Collider(1219,252,234,99)
        step6 = collider.Collider(1298,351,76,101)
        
        step7 = collider.Collider(1524,301,146,76)
        step8 = collider.Collider(1573,377,48,77)

        step9 = collider.Collider(2343,277,109,87)
        step10 = collider.Collider(2379,363,37,89)
        
        step11 = collider.Collider(3870,301,146,76)
        step12 = collider.Collider(3919,377,48,77)
        
        step13 = collider.Collider(4041,238,116,106)
        step14 = collider.Collider(4080,343,38,108)
        
        step15 = collider.Collider(4184,225,63,112)
        step16 = collider.Collider(4205,337,21,113)
    ...
    def setup_flag_pole(self):  # a tester
    ...
    def setup_juwico(self):
        ...
        self.juwico.rect.bottom = c.GROUND_HEIGHT_LEVEL2
