...
class Level3(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.game_info[c.COIN_TOTAL] = 2
        self.game_info[c.LEVEL_NUMBER] = '1-3'
        ...
        self.overhead_info_display = info.OverheadInfo(self.game_info, c.LEVEL3)
    ...
    def setup_steps(self):
        ...
        step1 = collider.Collider(0,532,599,68)
        step2 = collider.Collider(599,568,312,32)

        step3 = collider.Collider(759,560,36,8)
        step4 = collider.Collider(795,532,44,40)


        step5 = collider.Collider(839,564,32,12)
        step6 = collider.Collider(911,524,92,76)
        
        step7 = collider.Collider(1003,532,52,68)
        step8 = collider.Collider(1055,504,52,96)

        step9 = collider.Collider(1107,524,48,76)
        step10 = collider.Collider(1155,540,36,60)
        
        step11 = collider.Collider(1191,568,75,32)
        step12 = collider.Collider(1266,544,164,56)
        
        step13 = collider.Collider(1306,488,44,56)
        step14 = collider.Collider(1430,564,60,36)
        
        step15 = collider.Collider(2446,440,48,160)
        step16 = collider.Collider(1618,564,88,36)
        
        step17 = collider.Collider(1706,552,528,48)
        step18 = collider.Collider(2234,484,40,116)


        step19 = collider.Collider(2274,436,36,164)
        step20 = collider.Collider(2310,408,136,192)
        
        step21 = collider.Collider(2246,440,48,160)
        step22 = collider.Collider(2494,480,152,120)

        step23 = collider.Collider(2518,444,112,36)
        step24 = collider.Collider(2534,408,56,36)
        
        step25 = collider.Collider(2646,452,96,148)
        step26 = collider.Collider(2742,532,696,68)
        
        step27 = collider.Collider(2818,424,56,36)
        step28 = collider.Collider(2850,460,56,36)
        
        step29 = collider.Collider(2822,496,56,36)
        step30 = collider.Collider(3026,504,40,28)
        
        step31 = collider.Collider(3066,484,44,50)
        step32 = collider.Collider(3110,472,244,61)


        step33 = collider.Collider(3438,560,104,40)
        step34 = collider.Collider(3542,532,76,68)
        
        step35 = collider.Collider(3618,548,16,52)
        step36 = collider.Collider(3634,560,24,40)

        step37 = collider.Collider(3658,584,196,24)
        step38 = collider.Collider(3854,560,52,24)
        
        step39 = collider.Collider(3862,536,28,24)
        step40 = collider.Collider(3906,572,44,28)
        
        step41 = collider.Collider(3950,556,84,44)
        step42 = collider.Collider(4034,532,766,68)
        
        step43 = collider.Collider(4086,508,104,24)
        step44 = collider.Collider(4094,484,28,24)
        
        step45 = collider.Collider(4146,484,28,24)
    ...
    def setup_flag_pole(self):
        ...
        self.flag = flagpole.Flag(4466, 170)

        pole0 = flagpole.Pole(4466, 170)
        pole1 = flagpole.Pole(4466, 210)
        pole2 = flagpole.Pole(4466, 250)
        pole3 = flagpole.Pole(4466, 290)
        pole4 = flagpole.Pole(4466, 330)
        pole5 = flagpole.Pole(4466, 370)
        pole6 = flagpole.Pole(4466, 410)
        pole7 = flagpole.Pole(4466, 450)
        pole8 = flagpole.Pole(4466, 490)

        finial = flagpole.Finial(4466, 176)
    ...
    def setup_juwico(self):
        ...
        self.juwico.rect.bottom = c.GROUND_HEIGHT_LEVEL3
    ...
    def setup_checkpoints(self):
        ...
        check11 = checkpoint.Checkpoint(4466, '11', 5, 6)
        check12 = checkpoint.Checkpoint(4466+400, '12')
    ...
    def update_while_in_castle(self):
        ...
        if self.overhead_info_display.state == c.END_OF_LEVEL:
            ...
            self.flag_pole_group.add(castle_flag.Flag(4466+240, 322))
